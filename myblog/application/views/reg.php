...
<div id="OSC_Content" class="CenterDiv"><style>
        ...
        Filename: D:/Xampp/htdocs/PHP/myblog/system/database/DB_driver.php

                                                             Line Number: 436#OSC_Footer {border:0;}
...
<script>
    $('#f_email').on('blur',function () {
        $.get('welcome/reg_emil',{ emil:$('#f_email').val()},function (data) {
                    console.log(data)
        },'text')
    })
